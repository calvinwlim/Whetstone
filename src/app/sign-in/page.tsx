...
function SignIn() {
  ...
  async function signInWithGitHub() {
    ...
    // A success navigates away, so reaching here at all means it failed.
  ...
  return (
    <div className="mx-auto max-w-md">
      ...
      {status === "sent" ? (
        ...
        <>
          {/* First, because it is one click and costs no trip to an inbox.
              Nearly everyone this is built for already has an account. */}
          <button
            type="button"
            onClick={signInWithGitHub}
            className="key key-plain mt-5 flex w-full items-center justify-center gap-2 px-4 py-3"
          >
            <svg
              viewBox="0 0 16 16"
              aria-hidden
