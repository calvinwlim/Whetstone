...
const questions: Question[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { id: "b", text: "Every single append is guaranteed to run in constant time" },
      {
        id: "c",
        text: "It is O(1) on average across random inputs, but degrades to O(n) whenever an adversary controls the input",
      },
      { id: "d", text: "It is O(1) only when the array has been preallocated to its final size" },
    ],
    answer: "a",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      { id: "b", text: "O(1) — no data structures are ever allocated on the heap" },
      { id: "c", text: "O(log n) — recursion depth is logarithmic in the list size" },
      {
        id: "d",
        text: "O(n) worth of heap allocation, since each call's arguments must be copied and stored",
      },
    ],
    answer: "a",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      { id: "b", text: "A hash map cannot store more than a fixed number of keys at once" },
      {
        id: "c",
        text: "Balanced trees have faster individual lookups, since comparisons are cheaper than hashing",
      },
      { id: "d", text: "Hash maps do not support deleting a key once it has been inserted" },
    ],
    answer: "a",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      { id: "b", text: "When the graph is known to contain cycles" },
      { id: "c", text: "When memory is severely constrained, since BFS needs less of it than DFS" },
      { id: "d", text: "When the graph happens to be a tree rather than a general graph" },
    ],
    answer: "a",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      { id: "b", text: "O(n) extra time to reduce the space the scan needs" },
      {
        id: "c",
        text: "No real trade exists — the hash set version is strictly better in both time and space",
      },
      { id: "d", text: "O(log n) space in exchange for O(log n) time" },
    ],
    answer: "a",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      { id: "b", text: "A hash set holding every URL ever seen, with no bound on its size" },
      {
        id: "c",
        text: "A sorted array of every URL, searched with binary search for O(log n) lookups",
      },
      { id: "d", text: "A trie storing every URL one character at a time" },
    ],
    answer: "a",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      { id: "b", text: "O(log n) queries, costing O(log n) additional space" },
      { id: "c", text: "O(1) queries at no additional space cost at all" },
      { id: "d", text: "Faster insertion into the underlying array, at the cost of slower reads" },
    ],
    answer: "a",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      { id: "b", text: "O(n^2) — a loop nested inside another loop is always quadratic" },
      {
        id: "c",
        text: "O(n log n) — the inner pointer halves the remaining search range each outer step",
      },
      { id: "d", text: "O(n), but only when the input array has been sorted first" },
    ],
    answer: "a",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      { id: "b", text: "A rainbow table attack — defend by storing the keys salted" },
      { id: "c", text: "A cache stampede — defend by coalescing the colliding lookups" },
      {
        id: "d",
        text: "A birthday attack — defend against it by widening the hash output to at least 256 bits",
      },
    ],
    answer: "a",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "b",
        text: "Dereferencing a pointer is a fundamentally more expensive CPU instruction than an array index",
      },
      { id: "c", text: "Traversing a linked list is actually O(n^2), not O(n)" },
      {
        id: "d",
        text: "The extra pointer field doubles the number of additions the CPU performs",
      },
    ],
    answer: "a",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "b",
        text: "A min-heap of the elements not yet visited, giving the global minimum on each pop",
      },
      { id: "c", text: "A prefix sum array built once over the input values" },
      { id: "d", text: "A hash map from each value straight to its index in the array" },
    ],
    answer: "a",
    explanation:
