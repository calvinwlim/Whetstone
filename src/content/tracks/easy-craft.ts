...
export const questions: Question[] = [
  ...
  // ============================ Workplace Craft ===========================
  {
    ...
    options: [
      ...
      { id: "b", text: "Documenting a system in full detail after it has been built" },
      { id: "c", text: "Recording exactly who approved which decision, and when" },
      { id: "d", text: "Explaining the code in plain language to future maintainers" },
    ],
    answer: "a",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      { id: "b", text: "It simply makes the document a bit shorter overall" },
      {
        id: "c",
        text: "Solutions tend to change far more often than the underlying problems do",
      },
      { id: "d", text: "It is the required format at most companies" },
    ],
    answer: "a",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "b",
        text: "It is required for regulatory compliance purposes at most organisations of any real size",
      },
      { id: "c", text: "It helps identify exactly who was responsible for causing the problem" },
      { id: "d", text: "It replaces the need to write a full postmortem afterwards" },
    ],
    answer: "a",
    explanation:
  ...
  },
  {
    ...
    options: [
      ...
      {
        id: "b",
        text: "Smaller tasks are always completed proportionally faster than large ones",
      },
      { id: "c", text: "It makes the total estimate come out smaller" },
      { id: "d", text: "Managers generally prefer a detailed breakdown" },
    ],
    answer: "a",
    explanation:
